...
RUNS = WORK / "runs/dynamic_guard_horizon_pilot_v2"
...
def prepare():
    ...
    write_new(RUNS / "inputs.json", {
        ...
        "scope": "One fixed-phase horizon-guard simulation diagnostic after v1 observer domain error; no deployment/hardware acceptance."
    })
...
def run():
    ...
    for env in ("ROS_DOMAIN_ID=174", "ROS_LOCALHOST_ONLY=1",
                ...
                "TDT_PHASE_SECONDS=0", "IGN_PARTITION=tdt_dynamic_guard_horizon_v2"):
        args += ["-e", env]
