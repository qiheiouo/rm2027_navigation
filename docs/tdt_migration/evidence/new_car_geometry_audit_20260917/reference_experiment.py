...
ROOT=WORK/'runs/new_car_geometry_reference_v1'
...
def prepare():
    ...
    write_new(ROOT/'manifest.json',{'schema':'rm_tdt_planner/new_car_geometry_reference/v1',
        ...
        'diagnostic_change':'Nav2 DEBUG logging records actual adopted QP or validated fallback.',
...
def analyze_trial(path):
    ...
    logs=(path/'launch.log').read_text(errors='replace')
