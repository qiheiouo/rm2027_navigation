...
1. `rm_serial_driver`: serial IO, packet framing, CRC, validation.
...
Phase 1 may include compile-only migration of old serial parser and encoder code, plus unit tests for packet format, CRC, `vx/vy/wz` command packets, and referee parsing.
