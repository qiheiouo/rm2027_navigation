...
BASE=WORK/'runs/dynamic_odom_routing_pilot_v1/profiles/tdt_astar.yaml'
EXPECTED='c3a3ce2c6f5493d3b538866f94f173409fb4b6edfe5ca371fdf5f2d0c8bf95a8'
...
def run(mode):
    ...
    trial=SERIES/f'{mode}_tdt_astar_1'
    trial.mkdir(parents=True,exist_ok=False)
    data=profile(mode)
    (trial/'profile.yaml').write_bytes(data)
    files=[HERE/n for n in ('run_astar.py','run_trial.sh','static_map.py')]
